    ...
    <div class="left-bloc-text">
      <div class="content-text-up">
        ...
        <div class="content-bloc-description add-square">
          ...
          <div class="content-number-about-us green"><?php echo e($aboute->anneeCreat); ?></div>
          <?php else: ?>
    ...
    <div class="content-left-img ">
      ...
      <div class="content-text-up">
        <div class="header-title">
          ...
          <h4 class="text-justify"><?php echo e($about->resume2); ?></h4>
      ...
      <div class="content-key-figures flex">
        ...
        <div class="content-key-figure-wrapper flex">
          <div class="content-number number-key">+<span class="spin"><?php echo e($about->nombre3); ?></span></div>
        ...
        <div class="content-key-figure-wrapper flex">
          <div class="content-number number-key">+<span class="spin"><?php echo e($about->nombre4); ?></span></div>
          <div class="content-text-key-figure ">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front-end/defaut/base', ['title' => 'A propors de Batipro ','body_class' => 'about-us-page'] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/styve/dev/laravel/batipro/resources/views/front-end/about-us.blade.php ENDPATH**/ ?>