! function(e) { var t = {};
    ...
    function T(e) { var t, n, o, i, r;
        ...
        o(g) || e || c(f);
        A(), u("click", ".js-lcc-settings-toggle", (function() { M() })), u("click", ".js-lcc-accept", (function() { T("true"), l(v, !0), l(f) })), u("click", ".js-lcc-settings-save", (function() {! function() { var e;
                e = _.checked && y.checked ? N : _.checked ? p : y.checked ? E : k;
                T(e) }(), M(), l(f) })) }() }, function(e, t) {}]);