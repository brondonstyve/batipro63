...
class CreateLogementCollectifsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('logement_collectifs', function (Blueprint $table) {
            $table->id();
            $table->string('titre');
    ...
    {
        Schema::dropIfExists('logement_collectifs');
    }
}
