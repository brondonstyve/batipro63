...
} elseif ($_instance->childHasBeenRendered('fpSRG9A')) {
    $componentId = $_instance->getRenderedChildComponentId('fpSRG9A');
    $componentTag = $_instance->getRenderedChildComponentTagName('fpSRG9A');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fpSRG9A');
} else {
    $response = \Livewire\Livewire::mount('recherche');
    $html = $response->html();
    $_instance->logRenderedChild('fpSRG9A', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php echo $__env->make('front-end/defaut/base', ['title' => 'Projets | ', 'body_class' => 'projet-realisation'] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/styve/app/laravel/batipro/resources/views/front-end/detail-actualite.blade.php ENDPATH**/ ?>