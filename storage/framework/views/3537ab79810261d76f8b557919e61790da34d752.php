                  ...
                  <div class="card-body pt-4 p-3">
                      <ul class="list-group">
                        ...
                        <div
                            ...
                            <span class="alert-icon text-white"><i class="ni ni-like-2"></i></span>
                            <span
                                class="alert-text text-white"><?php echo __('Aucun article enregistré pour le moment. <br> &nbsp;&nbsp;&nbsp; Veuillez enregistrer un nouvel article dans le formulaire à droite.'); ?></span>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                            </button>
                        </div>
                        <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-8 mx-auto col-md-12 mb-xl-0 mt-2">
                                            <div class="card card-blog card-plain">
                                                <div class="position-relative">
                                                    <a class="d-block shadow-xl border-radius-xl">
                                                        <img src=" <?php echo e($imageC2->temporaryUrl()); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                    ...
                                    <?php else: ?>
                                    <?php if($this->actualite1->image): ?>
                                    <div class="row">
                                        <div class="col-xl-8 mx-auto col-md-12 mb-xl-0 mt-2">
                                            <div class="card card-blog card-plain">
                                                <div class="position-relative">
                                                    <a class="d-block shadow-xl border-radius-xl">
                                                        <img src=" <?php echo e(asset('/app/maison/'.$this->actualite1->image)); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH /home/styve/dev/laravel/batipro/resources/views/livewire/maison-contemporaine.blade.php ENDPATH**/ ?>