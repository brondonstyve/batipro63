                        ...
                        <div class="col-xl-3 col-md-6 mb-xl-0 mb-4 mt-2">
                            <div class="card card-blog card-plain">
                                ...
                                <div class="card-body px-1 pb-0">
                                    ...
                                    <p class="text-gradient text-dark mb-2 text-sm">service : <?php if($item->service=='Logement collectif'): ?> Maçonnerie Logement collectif <?php else: ?> <?php if($item->service=='Maçonnerie générale'): ?> Maçonnerie Maison <?php else: ?> <?php echo e($item->service); ?> <?php endif; ?> <?php endif; ?> </p>
                                    <a href="javascript:;">
                                        <h5>
...
unset($__errorArgs, $__bag); ?>">
                                            <input wire:model.lazy="projet.annee" class="form-control" type="number"
                                                placeholder="Année de réalisation" id="projet-email"  min="1000" max="<?php echo e(date('Y')); ?>">
                                        </div>
