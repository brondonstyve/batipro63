      ...
      <div class="container-main-bloc">
        <div class="container flex">
           ...
           <div class="container-main">
              <section class="container-banner" style="background-image:url({{asset('/app/terrain/'.$projet->img_principale)}}); width: 1422px;height: 500px;background-repeat: no-repeat">
                <div class="container">
                    ...
                    @foreach ($image as $item)
                        ...
                        <div class="item-projet-wrapper">
                            <div class="content-img-projet" >
                              <img src="{{asset('/app/terrain/'.$item)}}" style="width: 362px;height: 255px;">
                            </div>
