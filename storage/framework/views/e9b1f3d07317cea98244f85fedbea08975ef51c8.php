...
} elseif ($_instance->childHasBeenRendered('cKyJPRL')) {
    $componentId = $_instance->getRenderedChildComponentId('cKyJPRL');
    $componentTag = $_instance->getRenderedChildComponentTagName('cKyJPRL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cKyJPRL');
} else {
    $response = \Livewire\Livewire::mount('projet-mg');
    $html = $response->html();
    $_instance->logRenderedChild('cKyJPRL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
