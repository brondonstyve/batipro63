    ...
    <div class="container-logo-navigation top-fixed">
        ...
        <div class="container-navigation">
            <ul>
                ...
                <li><a class="<?php if(in_array(Route::currentRouteName(), ['service-front','mc','lc','mg'])): ?>   active <?php endif; ?>"  href="<?php echo e(route('service-front')); ?>">Services</a></li>
                ...
                <li><a class="<?php echo e(Route::currentRouteName() == 'temoignage' ? 'active' : ''); ?>"   href="<?php echo e(route('temoignage')); ?>">Témoignages</a></li>
            </ul>
        </div>
    </div>
<?php /**PATH /home/styve/app/laravel/batipro/resources/views/front-end/partials/header.blade.php ENDPATH**/ ?>