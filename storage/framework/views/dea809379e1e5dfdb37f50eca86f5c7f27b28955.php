                  ...
                  <div class="content-right-article ">
                    ...
                    <div class="content-other-article bloc-article">
                      ...
                      <div class="content-list-other-article  align-center">
                          <a href=" <?php echo e(route('detailMc',encrypt($actualite->id))); ?> ">
                    ...
                    <div class="content-categories-article ">
                      ...
                      <div class="content-list-categories">
                        <ul>
                            ...
                            <li><a href=" <?php echo e(route('mc')); ?> " class=""> <?php echo e($item->domaine.'  ('.($item->nombre).')'); ?> </a></li>      
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                      </div>
                    </div>
...
<?php echo $__env->make('front-end/defaut/base', ['title' => 'Projets | ', 'body_class' => 'projet-realisation'] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/styve/dev/laravel/batipro/resources/views/front-end/detail-mc.blade.php ENDPATH**/ ?>