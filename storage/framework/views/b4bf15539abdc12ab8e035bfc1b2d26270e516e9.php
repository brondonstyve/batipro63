 <main>  
    <div class="container-fluid py-4">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    ...
                    <h5 class="font-weight-bolder"><?php echo e(substr($this->services->libelle,0,35).'...'); ?></h5>
                    <p class="mb-5"><?php echo e(substr($this->services->description,0,150).'...'); ?></p>
                    <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="<?php echo e(route('services')); ?>">
                      Voir tout
            ...
            <div class="row">
              ...
              <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                <div class="bg-gradient-primary border-radius-lg h-100">
                  <img src="<?php echo e(asset('/assets/img/shapes/waves-white.svg')); ?>" class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
                  <div class="position-relative d-flex align-items-center justify-content-center h-100">
                    <img class="w-100 position-relative z-index-2 pt-4" src="<?php echo e(asset('/assets/img/illustrations/warning-rocket.png')); ?>">
                  </div>
                </div>
              </div>
            </div>
      ...
      <?php if($this->actualite!=null): ?>
      <div class="col-lg-5">
        <div class="card h-100 p-3">
          <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url(<?php echo e(asset('/app/actualite/'.$this->actualite->image)); ?>);">
            <span class="mask bg-gradient-dark"></span>
            <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
              <h5 class="text-white font-weight-bolder mb-4 pt-2">Dernière actualité</h5>
              <h6 class="text-white font-weight-bolder mb-4 pt-2"><?php echo e(substr($this->actualite->titre,0,35).'...'); ?></h6>
              <p class="text-white"><?php echo e(substr($this->actualite->article1,0,150).'...'); ?>.</p>
              <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="<?php echo e(route('actualite')); ?>">
...
<?php /**PATH /home/styve/app/laravel/batipro/resources/views/livewire/dashboard.blade.php ENDPATH**/ ?>