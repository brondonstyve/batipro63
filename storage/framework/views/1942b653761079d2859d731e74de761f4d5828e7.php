...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php else: ?>
                                            <?php if($this->home->imageMc): ?>
                                            <div class="row">
                                                <div class="col-xl-12 mx-auto col-md-12 mb-xl-0 mt-2">
                                                    <div class="card card-blog card-plain">
                                                        <div class="position-relative">
                                                            <a class="d-block shadow-xl border-radius-xl">
                                                                <img src=" <?php echo e(asset('/app/accueil/'.$this->home->imageMc)); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php else: ?>
                                            <?php if($this->home->imageLc): ?>
                                            <div class="row">
                                                <div class="col-xl-12 mx-auto col-md-12 mb-xl-0 mt-2">
                                                    <div class="card card-blog card-plain">
                                                        <div class="position-relative">
                                                            <a class="d-block shadow-xl border-radius-xl">
                                                                <img src=" <?php echo e(asset('/app/accueil/'.$this->home->imageLc)); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php else: ?>
                                            <?php if($this->home->imageMg): ?>
                                            <div class="row">
                                                <div class="col-xl-12 mx-auto col-md-12 mb-xl-0 mt-2">
                                                    <div class="card card-blog card-plain">
                                                        <div class="position-relative">
                                                            <a class="d-block shadow-xl border-radius-xl">
                                                                <img src=" <?php echo e(asset('/app/accueil/'.$this->home->imageMg)); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php else: ?>
                                            <?php if($this->home->image1): ?>
                                            <div class="row">
                                                <div class="col-xl-6 mx-auto col-md-12 mb-xl-0 mt-2">
                                                    <div class="card card-blog card-plain">
                                                        <div class="position-relative">
                                                            <a class="d-block shadow-xl border-radius-xl">
                                                                <img src=" <?php echo e(asset('/app/accueil/'.$this->home->image1)); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                            <button class="btn btn-primary btn-sm mt-2" type="button" disabled wire:loading wire:target='image5'>
                                                ...
                                                <?php if($image5): ?>
                                                    ...
                                                    <?php else: ?>
                                                    <?php if($this->home->petiteImage1): ?>
                                                    <div class="row">
                                                        <div class="col-xl-12 mx-auto col-md-12 mb-xl-0 mt-2">
                                                            <div class="card card-blog card-plain">
                                                                <div class="position-relative">
                                                                    <a class="d-block shadow-xl border-radius-xl">
                                                                        <img src=" <?php echo e(asset('/app/accueil/'.$this->home->petiteImage1)); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12 mx-auto col-md-12 mb-xl-0 mt-2">
                                                        <div class="card card-blog card-plain">
                                                            <div class="position-relative">
                                                                <a class="d-block shadow-xl border-radius-xl">
                                                                    <img src=" <?php echo e($image6->temporaryUrl()); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <?php else: ?>
                                                <?php if($this->home->petiteImage2): ?>
                                                <div class="row">
                                                    <div class="col-xl-12 mx-auto col-md-12 mb-xl-0 mt-2">
                                                        <div class="card card-blog card-plain">
                                                            <div class="position-relative">
                                                                <a class="d-block shadow-xl border-radius-xl">
                                                                    <img src=" <?php echo e(asset('/app/accueil/'.$this->home->petiteImage2)); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                            <button class="btn btn-primary btn-sm mt-2" type="button" disabled wire:loading wire:target='image7'>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12 mx-auto col-md-12 mb-xl-0 mt-2">
                                                        <div class="card card-blog card-plain">
                                                            <div class="position-relative">
                                                                <a class="d-block shadow-xl border-radius-xl">
                                                                    <img src=" <?php echo e($image7->temporaryUrl()); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <?php else: ?>
                                                <?php if($this->home->petiteImage3): ?>
                                                <div class="row">
                                                    <div class="col-xl-12 mx-auto col-md-12 mb-xl-0 mt-2">
                                                        <div class="card card-blog card-plain">
                                                            <div class="position-relative">
                                                                <a class="d-block shadow-xl border-radius-xl">
                                                                    <img src=" <?php echo e(asset('/app/accueil/'.$this->home->petiteImage3)); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12 mx-auto col-md-12 mb-xl-0 mt-2">
                                                        <div class="card card-blog card-plain">
                                                            <div class="position-relative">
                                                                <a class="d-block shadow-xl border-radius-xl">
                                                                    <img src=" <?php echo e($image8->temporaryUrl()); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <?php else: ?>
                                                <?php if($this->home->petiteImage4): ?>
                                                <div class="row">
                                                    <div class="col-xl-12 mx-auto col-md-12 mb-xl-0 mt-2">
                                                        <div class="card card-blog card-plain">
                                                            <div class="position-relative">
                                                                <a class="d-block shadow-xl border-radius-xl">
                                                                    <img src=" <?php echo e(asset('/app/accueil/'.$this->home->petiteImage4)); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6 mx-auto col-md-12 mb-xl-0 mt-2">
                                                    <div class="card card-blog card-plain">
                                                        <div class="position-relative">
                                                            <a class="d-block shadow-xl border-radius-xl">
                                                                <img src=" <?php echo e($image9->temporaryUrl()); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <?php else: ?>
                                            <?php if($this->home->imageE): ?>
                                            <div class="row">
                                                <div class="col-xl-6 mx-auto col-md-12 mb-xl-0 mt-2">
                                                    <div class="card card-blog card-plain">
                                                        <div class="position-relative">
                                                            <a class="d-block shadow-xl border-radius-xl">
                                                                <img src=" <?php echo e(asset('/app/accueil/'.$this->home->imageE)); ?> " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
...
<?php /**PATH /home/styve/dev/laravel/batipro/resources/views/livewire/home-config.blade.php ENDPATH**/ ?>