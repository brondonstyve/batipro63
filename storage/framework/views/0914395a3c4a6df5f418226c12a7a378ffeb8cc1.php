      ...
      <div class="container-main-bloc">
        <div class="container flex">
           ...
           <div class="container-main">
              <section class="container-banner" style="background-image:url(<?php echo e(asset('/app/projet/'.$projet->img_principale)); ?>); min-width: 1422px;height: 500px;background-repeat: repeat">
                <div class="container">
