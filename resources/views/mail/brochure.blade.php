                            ...
                            <tbody>
                                <tr>
                                    <td style="padding:15px;color:#333;font-size:16px;font-family:sans-serif">
                                        ...
                                        <p>Suite à la demande que vous avez effectué sur notre site, veuillez trouvez ci-après la page de téléchargement de notre catalogue : <a href="{{route('down')}}" rel="nofollow noopener noreferrer nofollow noopener noreferrer"
