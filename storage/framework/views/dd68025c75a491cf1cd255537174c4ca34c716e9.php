<section class="footer">
  ...
  <section id="nav-off">
                  <div class="infobul">
                      ...
                      <ul class="list">
                          ...
                          <li class="mail">
                              <h6>Envoyez</h6>
                              <p><a href="<?php echo e(route('contact')); ?>">Un message</a></p>
                          </li>
                          <li class="tchat">
                              <h6>Tchatez</h6>
                          ...
                          <li class="pdf">
                              <h6>Consultez</h6>
                              <p><a href="<?php echo e(route('brochure')); ?>">La brochure</a></p>
                          </li>
                      </ul>
                  </div>
  </section>
  ...
  <?php /**PATH /home/styve/app/laravel/batipro/resources/views/front-end/partials/footer.blade.php ENDPATH**/ ?>