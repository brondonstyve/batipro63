<div>
                  ...
                  <div class="card-body pt-4 p-3">
                      <ul class="list-group">
                        ...
                        <div
                            ...
                            <span class="alert-icon text-white"><i class="ni ni-like-2"></i></span>
                            <span
                                class="alert-text text-white">{!! __('Aucun article enregistré pour le moment. <br> &nbsp;&nbsp;&nbsp; Veuillez enregistrer une nouvel article dans le formulaire à droite.')!!}</span>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                            </button>
                        </div>
                        @else
                        ...
                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                            <div class="d-flex flex-column col-md-9 text-justify">
                                ...
                                <span class="mb-2 text-xs">Domaine   &nbsp;&nbsp;&nbsp;&nbsp;: <span class="text-dark ms-2 font-weight-bold">{{$actualite->article1}} </span></span>
    ...
    @error('imageDesc') <span class="text text-danger error">Erreur lors du téléchargement</span> @enderror
             ...
             <div class="form-group">
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-xl-4 mx-auto col-md-12 mb-xl-0 mt-2">
                            <div class="card card-blog card-plain">
                                <div class="position-relative">
                                    <a class="d-block shadow-xl border-radius-xl">
                                        <img src=" {{$imageDesc->temporaryUrl()}} " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    @else
                    @if ($this->actualite1->imageDesc)
                    <div class="row">
                        <div class="col-xl-4 mx-auto col-md-12 mb-xl-0 mt-2">
                            <div class="card card-blog card-plain">
                                <div class="position-relative">
                                    <a class="d-block shadow-xl border-radius-xl">
                                        <img src=" {{ asset('/app/maison/'.$this->actualite1->imageDesc)}} " alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                    </a>
                                </div>
                            </div>
                        </div>
