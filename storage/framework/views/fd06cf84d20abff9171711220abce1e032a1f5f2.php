                  ...
                  <div class="card-body pt-4 p-3">
                      <ul class="list-group">
                        ...
                        <div
                            ...
                            <span class="alert-icon text-white"><i class="ni ni-like-2"></i></span>
                            <span
                                class="alert-text text-white"><?php echo __('Aucune vidéos enregistrée pour le moment. <br> &nbsp;&nbsp;&nbsp; Veuillez enregistrer une Nouveau vidéos dans le formulaire à droite.'); ?></span>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                            </button>
                        </div>
                        <?php else: ?>
                        ...
                        <li class="list-group-item col-md-12 border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg" wire:model='supp'>
                            <div class="d-flex  flex-column text-justify">
                               <h4 class="mb-3 text-sm alert alert-danger text-white text-center"><i class="fa fa-warning" aria-hidden="true"></i>  Confirmation de suppression de vidéos <?php echo e($temoignage->titre); ?></h4>
                        ...
                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                            <div class="d-flex flex-column col-md-9 text-justify">
                                <h4 class="mb-3 text-sm">Type &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo e($temoignage->type); ?></h4>
...
<?php /**PATH /home/styve/dev/laravel/batipro/resources/views/livewire/temoignage.blade.php ENDPATH**/ ?>