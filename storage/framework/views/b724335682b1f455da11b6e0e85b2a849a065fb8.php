        ...
        <div class="lcc-modal__content">
            ...
            <div class="lcc-modal__section">
                <label for="lcc-checkbox-analytics" class="lcc-label">
                    ...
                    <span><?php echo app('translator')->get('cookie-consent::texts.setting_analytics'); ?></span> <span> <?php echo app('translator')->get('cookie-consent::texts.setting_video'); ?></span><span> <?php echo app('translator')->get('cookie-consent::texts.setting_comment'); ?></span> 
                </label>
                <p class="lcc-text">
