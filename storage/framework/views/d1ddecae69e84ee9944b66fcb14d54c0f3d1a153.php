...
} elseif ($_instance->childHasBeenRendered('mTp4gwe')) {
    $componentId = $_instance->getRenderedChildComponentId('mTp4gwe');
    $componentTag = $_instance->getRenderedChildComponentTagName('mTp4gwe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mTp4gwe');
} else {
    $response = \Livewire\Livewire::mount('recherche');
    $html = $response->html();
    $_instance->logRenderedChild('mTp4gwe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
