...
} elseif ($_instance->childHasBeenRendered('jTgpdOD')) {
    $componentId = $_instance->getRenderedChildComponentId('jTgpdOD');
    $componentTag = $_instance->getRenderedChildComponentTagName('jTgpdOD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jTgpdOD');
} else {
    $response = \Livewire\Livewire::mount('projet3');
    $html = $response->html();
    $_instance->logRenderedChild('jTgpdOD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
           </div>
...
<?php echo $__env->make('front-end/defaut/base', ['title' => 'Projets | ', 'body_class' => 'projet-realisation'] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/styve/app/laravel/batipro/resources/views/front-end/lc.blade.php ENDPATH**/ ?>